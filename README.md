...
- **Cart drawer** працює частково:
  ...
  - ⚠️ Якщо додається **перший товар** — дровер відкривається, але не завжди оновлює контент належним чином (потрібне додаткове оновлення фокусу в DOM).
- Секції адаптивні, налаштовуються через адмінку й повністю інтегровані в тему Dawn.
